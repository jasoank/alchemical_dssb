...
# load energy minimization .mdp file for forward mutation
gmx_mpi grompp -f $mdp_dir/eqA/em-A.mdp -c ../ions.pdb -p ../newtop.top -o enmin.tpr -maxwarn 1
...
# load NVT minimization .mdp file for forward mutation
gmx_mpi grompp -f $mdp_dir/eqA/nvt-A.mdp -r enmin.gro -c enmin.gro -p ../newtop.top -o nvt.tpr -maxwarn 3

# Perform NVT equilibriation
gmx_mpi mdrun -s nvt.tpr -deffnm nvt -v

# load NPT minimization .mdp file for forward mutation
gmx_mpi grompp -f $mdp_dir/eqA/npt-A.mdp -r nvt.gro -c nvt.gro -p ../newtop.top -o npt.tpr -maxwarn 3

# Perform NPT equilibriation
gmx_mpi mdrun -s npt.tpr -deffnm npt -v

#  load the .mdp file for production MD of forward mutation
gmx_mpi grompp -f $mdp_dir/eqA/md.mdp -c npt.gro -p ../newtop.top -o equil.tpr -maxwarn 4
...
for i in $( seq 1 100 ); do
  cd frame$i
  gmx_mpi grompp -f $mdp_dir/eqA/morph.mdp -c frame.gro -p ../../newtop.top -o nonequil.tpr -maxwarn 4
